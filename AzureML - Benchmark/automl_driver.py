...
workspace_name = "kgl-amx-workspace" # PLACEHOLDER
subscription_id = "22b9cfe5-4bdb-4e69-a411-56faf8c2f1bf" # PLACEHOLDER
resource_group = "kgl-amx" # PLACEHOLDER
experiment_name = "kgl-amx-exp" # PLACEHOLDER
iteration = "22"  # PLACEHOLDER
run_id = "AutoML_b9a3bed7-2c52-43d5-9138-d459f841f821_22"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'save_mlflow':True,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'whitelist_models':None,'compute_target':'kgl-compute','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':60,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':60,'max_concurrent_iterations':1,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':5,'name':'kgl-amx-exp','path':'./sample_projects/kgl-amx-exp','primary_metric':'AUC_weighted','region':'eastus','resource_group':'kgl-amx','subscription_id':'22b9cfe5-4bdb-4e69-a411-56faf8c2f1bf','task_type':'classification','validation_size':None,'test_size':0.15,'vm_type':'STANDARD_DS3_V2','workspace_name':'kgl-amx-workspace','label_column_name':'target','positive_label':None,'tuning_config':{'enable_tuning_run':True},'enable_batch_run':True,'dataset_id':'98a59c5d-89ee-4477-bcb0-6cbd9427fa03'} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Stack_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.stack_ensemble\",\"class_name\":\"StackEnsemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'classification','primary_metric':'AUC_weighted','ensemble_iterations':15,'is_timeseries':False,'name':'kgl-amx-exp','compute_target':'kgl-compute','subscription_id':'22b9cfe5-4bdb-4e69-a411-56faf8c2f1bf','region':'eastus','grain_column_names':None}\",\"ensemble_run_id\":\"AutoML_b9a3bed7-2c52-43d5-9138-d459f841f821_22\",\"experiment_name\":\"kgl-amx-exp\",\"workspace_name\":\"kgl-amx-workspace\",\"subscription_id\":\"22b9cfe5-4bdb-4e69-a411-56faf8c2f1bf\",\"resource_group_name\":\"kgl-amx\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Stack_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"98a59c5d-89ee-4477-bcb0-6cbd9427fa03\"}}" # PLACEHOLDER
